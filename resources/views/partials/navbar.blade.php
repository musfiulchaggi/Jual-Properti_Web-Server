<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="/">Bakul Properti</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item">
            ...
            {{-- menggunakan middleware auth dan guest untuk melihat apakah user sudah login atau belum --}}
            <ul class="navbar-nav ms-auto">
                ...
                @else
                    {{-- ms-auto digunakan untuk rata kiri secara otomatis --}}
                    {{-- <li class="nav-item">
